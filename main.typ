...
// Physics-related tools for equations
...
// Main styling, containing the majority of typesetting including document layout, fonts, heading styling, figure styling, outline styling, etc. Some parts of the styling are customizable.
#show: base.with(
  // These first two parameters are only used for the pdf metadata.
  title: "Estados ligados de Andreev y modos topológicos en superconductores exóticos",
  name: "Gabriel Fernando Rodríguez Ruiz",
  // What is displayed at the top-right of the page. The top-left of the page displays the current chapter.
  rightheader: "Gabriel Fernando Rodríguez Ruiz",
  // Main and math fonts
...
#maketitlepage(
  ...
  daily-supervisor: [Dra. Liliana Arrachea],
